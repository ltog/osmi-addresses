...
On Ubuntu/Debian, you should be able to get all of libosmium's and osmi-addresses's dependencies with:
    ...
    sudo apt-get install clang libboost-dev libboost-filesystem-dev libgdal1-dev libsparsehash-dev libbz2-dev libexpat1-dev sqlite3 spatialite-bin colordiff parallel realpath
